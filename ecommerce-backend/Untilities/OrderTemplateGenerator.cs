...
{
    public class OrderTemplateGenerator: IOrderTemplateGenerator
    {
        private readonly EcommerceContext _context;

        public OrderTemplateGenerator(EcommerceContext context)
        {
            _context = context;
        }
